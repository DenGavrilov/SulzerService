...
public class CheckMotorActivity extends Activity {

    private CircularImageView motorImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_motor);
        ...
        commentsMotorText = (EditText) findViewById(R.id.commentsMotorText);
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    ...
                    case R.id.btnRegister:
                        ...
                        String installValue = spinner_1.getSelectedItem().toString();
                        String bracketsValue = spinner_2.getSelectedItem().toString();
                        String shimsValue = spinner_3.getSelectedItem().toString();
                        ...
                        String commentValue = commentsMotorText.getText().toString();

                        Boolean insert = databaseHelper.insertMotorReport(reportIdValue, installValue, bracketsValue, shimsValue, commentValue, imageUri);

                        if(insert==true){
                            Toast.makeText(CheckMotorActivity.this, R.string.data_added, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CheckMotorActivity.this, CheckInstallActivity.class);
                            ...
                            Toast.makeText(CheckMotorActivity.this, R.string.registration_failed, Toast.LENGTH_SHORT).show();
                        }
        ...
        if (resultCode==RESULT_OK){
            ...
            if (requestCode==IMAGE_PICK_GALLERY_CODE){
                ...
                if (resultCode==RESULT_OK){
                    ...
                    imageUri = resultUri;
                    motorImg.setImageURI(resultUri);
                }
