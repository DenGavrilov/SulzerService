...
public class CheckFlangesActivity extends Activity {

    private CircularImageView flangesImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_flanges);

        btnCancel = findViewById(R.id.btnLogin);
        btnRegister = findViewById(R.id.btnRegister);
        btnTakePicture = findViewById(R.id.btnTakePicture);
        flangesImg = findViewById(R.id.flangesImg);
        userText = findViewById(R.id.userText);
        reportText = findViewById(R.id.reportText);
        userBuffer = findViewById(R.id.userBuffer);
        pumpBuffer = findViewById(R.id.pumpBuffer);
        commentsFlangesText = (EditText) findViewById(R.id.commentsFlangesText);
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    ...
                    case R.id.btnRegister:
                        ...
                        String fastenersValue = spinner_1.getSelectedItem().toString();
                        String flangesValue = spinner_2.getSelectedItem().toString();
                        String gasketsValue = spinner_3.getSelectedItem().toString();
                        ...
                        String commentValue = commentsFlangesText.getText().toString();

                        Boolean insert = databaseHelper.insertFlangesReport(reportIdValue, fastenersValue, flangesValue, gasketsValue, commentValue, imageUri);

                        if(insert==true){
                            Toast.makeText(CheckFlangesActivity.this, R.string.data_added, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CheckFlangesActivity.this, CheckInstallActivity.class);
                            ...
                            Toast.makeText(CheckFlangesActivity.this, R.string.registration_failed, Toast.LENGTH_SHORT).show();
                        }
        ...
        if (resultCode==RESULT_OK){
            ...
            if (requestCode==IMAGE_PICK_GALLERY_CODE){
                ...
                if (resultCode==RESULT_OK){
                    ...
                    imageUri = resultUri;
                    flangesImg.setImageURI(resultUri);
                }
