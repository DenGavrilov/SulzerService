...
public class CheckCouplingActivity extends Activity {

    private CircularImageView couplingImg;
    ...
    Button btnCancel;
    Button btnRegister;
    Spinner spinner_1, spinner_2, spinner_3, spinner_4, spinner_5, spinner_6;
    EditText commentsText;
    TextView userText;
    TextView reportText;
    TextView userBuffer;
    TextView pumpBuffer;
    TextView commentsCouplingText;
    Cursor resultUserId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_coupling);

        btnCancel = (Button) findViewById(R.id.btnLogin);
        btnRegister = (Button) findViewById(R.id.btnRegister);
        btnTakePicture = (Button) findViewById(R.id.btnTakePicture);
        couplingImg = findViewById(R.id.couplingImg);
        userText = findViewById(R.id.userText);
        reportText = findViewById(R.id.reportText);
        userBuffer = findViewById(R.id.userBuffer);
        pumpBuffer = findViewById(R.id.pumpBuffer);
        commentsCouplingText = findViewById(R.id.commentsCouplingText);
        ...
        commentsText = (EditText) findViewById(R.id.commentsCouplingText);
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    ...
                    case R.id.btnRegister:
                        ...
                        String sizeValue = spinner_1.getSelectedItem().toString();
                        String typeValue = spinner_2.getSelectedItem().toString();
                        String spacerValue = spinner_3.getSelectedItem().toString();
                        String screwValue = spinner_4.getSelectedItem().toString();
                        String alignValue = spinner_5.getSelectedItem().toString();
                        String guardValue = spinner_6.getSelectedItem().toString();
                        ...
                        String commentValue = commentsCouplingText.getText().toString();

                        Boolean insert = databaseHelper.insertCouplingReport(reportIdValue, sizeValue, typeValue, spacerValue, screwValue, alignValue, guardValue, commentValue, imageUri);
                        if(insert==true){
                            Toast.makeText(CheckCouplingActivity.this, R.string.data_added, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CheckCouplingActivity.this, CheckInstallActivity.class);
                            ...
                            Toast.makeText(CheckCouplingActivity.this, R.string.registration_failed, Toast.LENGTH_SHORT).show();
                        }
        ...
        if (resultCode==RESULT_OK){
            ...
            if (requestCode==IMAGE_PICK_GALLERY_CODE){
                ...
                if (resultCode==RESULT_OK){
                    ...
                    imageUri = resultUri;
                    couplingImg.setImageURI(resultUri);
                }
