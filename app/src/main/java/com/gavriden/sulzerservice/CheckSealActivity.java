...
public class CheckSealActivity extends Activity {

    private CircularImageView sealImg;
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    ...
                    case R.id.btnRegister:
                        ...
                        String typeValue = spinner_1.getSelectedItem().toString();
                        String jointsValue = spinner_2.getSelectedItem().toString();
                        String settingsValue = spinner_3.getSelectedItem().toString();
                        String controlUnitValue = spinner_4.getSelectedItem().toString();
                        ...
                        String commentValue = commentsSealText.getText().toString();

                        Boolean insert = databaseHelper.insertSealReport(reportIdValue, typeValue, jointsValue, settingsValue, controlUnitValue, commentValue, imageUri);

                        if(insert==true){
                            Toast.makeText(CheckSealActivity.this, R.string.data_added, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CheckSealActivity.this, CheckInstallActivity.class);
                            ...
                            Toast.makeText(CheckSealActivity.this, R.string.registration_failed, Toast.LENGTH_SHORT).show();
                        }
