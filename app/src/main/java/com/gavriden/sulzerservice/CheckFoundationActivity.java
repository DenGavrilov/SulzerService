...
public class CheckFoundationActivity extends Activity {

    private CircularImageView foundationImg;
    ...
    TextView userBuffer;
    TextView pumpBuffer;
    TextView commentsFoundationText;
    Cursor resultUserId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_foundation);

        btnCancel = findViewById(R.id.btnLogin);
        btnRegister = findViewById(R.id.btnRegister);
        btnTakePicture = findViewById(R.id.btnTakePicture);
        foundationImg = findViewById(R.id.pipeImg);
        userText = findViewById(R.id.userText);
        reportText = findViewById(R.id.reportText);
        userBuffer = findViewById(R.id.userBuffer);
        pumpBuffer = findViewById(R.id.pumpBuffer);
        commentsFoundationText = (EditText) findViewById(R.id.commentsFoundationText);
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    ...
                    case R.id.btnRegister:
                        ...
                        String executionValue = spinner_1.getSelectedItem().toString();
                        String groutingValue = spinner_2.getSelectedItem().toString();
                        String motorStandValue = spinner_3.getSelectedItem().toString();
                        String liftingArmValue = spinner_4.getSelectedItem().toString();
                        ...
                        String commentValue = commentsFoundationText.getText().toString();

                        Boolean insert = databaseHelper.insertFoundationReport(reportIdValue, executionValue, groutingValue, motorStandValue, liftingArmValue, commentValue, imageUri);

                        if(insert==true){
                            Toast.makeText(CheckFoundationActivity.this, R.string.data_added, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CheckFoundationActivity.this, CheckInstallActivity.class);
                            ...
                            Toast.makeText(CheckFoundationActivity.this, R.string.registration_failed, Toast.LENGTH_SHORT).show();
                        }
        ...
        if (resultCode==RESULT_OK){
            ...
            if (requestCode==IMAGE_PICK_GALLERY_CODE){
                ...
                if (resultCode==RESULT_OK){
                    ...
                    imageUri = resultUri;
                    foundationImg.setImageURI(resultUri);
                }
