...
public class SelectWetActivity extends Activity {
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    ...
                    case R.id.btnDisassemblyWet:
                        Intent b = new Intent(SelectWetActivity.this, VideoDetachSideplate.class);
                        startActivity(b);
                    ...
                    case R.id.btnReassemblyWet:
                        Intent ps = new Intent(SelectWetActivity.this, VideoInstallationImpeller.class);
                        startActivity(ps);
                        overridePendingTransition(R.anim.right_in, R.anim.alpha);
                        finish();
                        break;
