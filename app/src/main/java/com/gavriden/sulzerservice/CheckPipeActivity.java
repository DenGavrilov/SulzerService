...
public class CheckPipeActivity extends Activity {

    private CircularImageView pipeImg;
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    ...
                    case R.id.btnRegister:
                        ...
                        String genPipeValue = spinner_1.getSelectedItem().toString();
                        String bendsValue = spinner_2.getSelectedItem().toString();
                        String inletValue = spinner_3.getSelectedItem().toString();
                        String locationValue = spinner_4.getSelectedItem().toString();
                        String supportsValue = spinner_5.getSelectedItem().toString();
                        String installValue = spinner_6.getSelectedItem().toString();
                        ...
                        String commentValue = commentsPipeText.getText().toString();

                        Boolean insert = databaseHelper.insertPipeReport(reportIdValue, genPipeValue, bendsValue, inletValue, locationValue, supportsValue, installValue, commentValue, imageUri);
                        if(insert==true){
                            Toast.makeText(CheckPipeActivity.this, R.string.data_added, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CheckPipeActivity.this, CheckInstallActivity.class);
                            ...
                            Toast.makeText(CheckPipeActivity.this, R.string.registration_failed, Toast.LENGTH_SHORT).show();
                        }
