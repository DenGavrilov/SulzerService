...
public class CheckLubricationActivity extends Activity {

    private CircularImageView lubricationImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_lubrication);

        btnCancel = findViewById(R.id.btnLogin);
        btnRegister = findViewById(R.id.btnRegister);
        btnTakePicture = findViewById(R.id.btnTakePicture);
        lubricationImg = findViewById(R.id.lubricationImg);
        userText = findViewById(R.id.userText);
        reportText = findViewById(R.id.reportText);
        userBuffer = findViewById(R.id.userBuffer);
        pumpBuffer = findViewById(R.id.pumpBuffer);
        commentsLubText = (EditText) findViewById(R.id.commentsLubText);
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    ...
                    case R.id.btnRegister:
                        ...
                        String levelValue = spinner_2.getSelectedItem().toString();
                        ...
                        String commentValue = commentsLubText.getText().toString();

                        Boolean insert = databaseHelper.insertLubReport(reportIdValue, typeValue, levelValue, commentValue, imageUri);
                        if(insert==true){
                            Toast.makeText(CheckLubricationActivity.this, R.string.data_added, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CheckLubricationActivity.this, CheckInstallActivity.class);
                            ...
                            Toast.makeText(CheckLubricationActivity.this, R.string.registration_failed, Toast.LENGTH_SHORT).show();
                        }
        ...
        if (resultCode==RESULT_OK){
            ...
            if (requestCode==IMAGE_PICK_GALLERY_CODE){
                ...
                if (resultCode==RESULT_OK){
                    ...
                    imageUri = resultUri;
                    lubricationImg.setImageURI(resultUri);
                }
